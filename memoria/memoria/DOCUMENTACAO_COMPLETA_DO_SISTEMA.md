...
# Documentacao Completa do Sistema KYRONIX S.E.N.O

## 1. Visao geral

O KYRONIX S.E.N.O e um sistema web de gestao escolar construido como SPA em React + Vite, com autenticacao, banco de dados e storage no Supabase. A interface principal usa uma metafora de desktop, na qual os modulos funcionais sao abertos como aplicativos internos com janelas, atalhos e permissao por perfil.
